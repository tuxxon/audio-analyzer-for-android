...
public class AnalyzeActivity extends AppCompatActivity implements OnLongClickListener, OnClickListener,
  ...
  private void initPermission() {
    if (PermissionHelper.checkRecordAndStoragePermissions(this,
            PermissionHelper.RECORDAUDIO_REQUEST_CODE)) {
    }
  }
  ...
  public void onRequestPermissionsResult(final int requestCode,
    ...
    switch (requestCode) {
      case PermissionHelper.RECORDAUDIO_REQUEST_CODE:
        break;
      case PermissionHelper.RECORDAUDIO_DIALOG_REQUEST_CODE:
        break;
    }
  }
}